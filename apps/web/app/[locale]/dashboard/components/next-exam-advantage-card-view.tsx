...
export const NextExamAdvantageCardView = ({
  ...
  return (
    <div className="relative mb-8 overflow-hidden rounded-2xl border border-gray-200 bg-gray-50 p-6 shadow-sm dark:border-white/10 dark:bg-white/5 sm:p-8">
      <button
        type="button"
        onClick={dismiss}
        aria-label="Dismiss"
      ...
      <div className="relative flex items-start gap-4">
        ...
        <div className="min-w-0 flex-1 pr-6">
          ...
          <p className="mt-2 max-w-xl text-sm leading-relaxed text-gray-600 dark:text-gray-300">
            Your next exam question bank is calibrated to areas you struggled the most on this
            exam. Keep practicing &mdash; we are studying your patterns and mistakes.
          </p>
